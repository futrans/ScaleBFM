...
from scaletrack.assets import ASSET_DIR
...
G1_29DOF_CYLINDER_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ASSET_DIR}/robots/g1_29dof/g1_29dof.usda",
...
for a in G1_29DOF_CYLINDER_CFG.actuators.values():
    ...
    for n in names:
        if n in ["waist_roll_joint", "waist_pitch_joint", "waist_yaw_joint"]:
            G1_29DOF_ACTION_SCALE[n] = 0.25
