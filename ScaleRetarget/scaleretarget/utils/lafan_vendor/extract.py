...
def read_bvh_multi_channel(filename, start=None, end=None, order=None):
    """
    Reads a BVH file and extracts animation information.
    ...
    for line in f:
        ...
        if dmatch:
            ...
            # assert start_idx == len(data_block) and start_idx == channel_idx_list[-1] and len(channel_idx_list) - 1 == positions.shape[1]
