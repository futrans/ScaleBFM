...
from scaleretarget.utils.shape_optimizer import optimize_geno_shape

class GenoLoader(BaseLoader):
    ...
    def _optimize_shape(self, bvh_file):
        ...
        if self.use_optimized_shape:
            ...
            self.scale = optimize_geno_shape(
    ...
    def _get_root_height(self, bvh_data):
        ...
        foot_index = [bvh_joint_names.index(j) for j in ['RightFoot', 'RightToeBase','RightToeBaseEnd', 'LeftFoot', 'LeftToeBase','LeftToeBaseEnd']]
