...
class SnapMogenLoader(BaseLoader):
    ...
    def _load_sample(self, sample_path):
        ...
        bvh_data.pos = bvh_data.pos[1:-3] # snapmogen first frame is T-pose
        bvh_data.quats = bvh_data.quats[1:-3]
        ...
        for frame in range(bvh_data.pos.shape[0]):
            ...
            result["LeftFootMod"] = (result["L_foot0001_bind_JNT"][0], result["L_foot0002_bind_JNT"][1])
            result["RightFootMod"] = (result["R_foot0001_bind_JNT"][0], result["R_foot0002_bind_JNT"][1])
            
            frames.append(result)
        
        # human_height = 0.857  # cm to m
    ...
    def _get_root_height(self, bvh_data):
        ...
        foot_index = [bvh_joint_names.index(j) for j in ['L_foot0001_bind_JNT', 'L_foot0002_bind_JNT', 'R_foot0001_bind_JNT', 'R_foot0002_bind_JNT']]
